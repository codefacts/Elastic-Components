...
import tracker.server.generators.response.DeleteHttpResponseGenerator;

/**
 * Created by sohan on 7/4/2017.
 */
final public class DeleteHttpResponseGeneratorImpl implements DeleteHttpResponseGenerator {
    @Override
