...
import tracker.server.generators.response.UpdateHttpResponseGenerator;

/**
 * Created by sohan on 7/4/2017.
 */
final public class UpdateHttpResponseGeneratorImpl implements UpdateHttpResponseGenerator {
    @Override
