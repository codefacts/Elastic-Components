...
import tracker.server.generators.response.DeleteAllHttpResponseGenerator;

/**
 * Created by sohan on 7/4/2017.
 */
final public class DeleteAllHttpResponseGeneratorImpl implements DeleteAllHttpResponseGenerator {
    @Override
