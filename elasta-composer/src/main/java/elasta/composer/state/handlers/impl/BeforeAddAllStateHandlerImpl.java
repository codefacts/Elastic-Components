 ...
 */
final public class BeforeAddAllStateHandlerImpl implements BeforeAddAllStateHandler {
    final Fun2Async<Msg<JsonArray>, JsonObject, JsonObject> fun2Async;

    public BeforeAddAllStateHandlerImpl() {
        this((msg, jsonObject) -> Promises.of(jsonObject));
    }

    public BeforeAddAllStateHandlerImpl(Fun2Async<Msg<JsonArray>, JsonObject, JsonObject> fun2Async) {
