...
import elasta.composer.flow.builder.AddChildFlowBuilder;
 ...
 */
final public class AddChildFlowBuilderImpl implements AddChildFlowBuilder {
    final MsgEnterEventHandlerP startHandler;
    final MsgEnterEventHandlerP authorizeHandler;
    final MsgEnterEventHandlerP childIdGenerationHandler;
    ...
    public AddChildFlowBuilderImpl(MsgEnterEventHandlerP startHandler, MsgEnterEventHandlerP authorizeHandler, MsgEnterEventHandlerP childIdGenerationHandler, MsgEnterEventHandlerP validateHandler, MsgEnterEventHandlerP insertHandler, MsgEnterEventHandlerP broadcastHandler, MsgEnterEventHandlerP generateResponseHandler, MsgEnterEventHandlerP endHandler) {
        Objects.requireNonNull(startHandler);
        Objects.requireNonNull(authorizeHandler);
        Objects.requireNonNull(childIdGenerationHandler);
        ...
        this.childIdGenerationHandler = childIdGenerationHandler;
    ...
    public Flow build() {
        return Flow.builder()
            ...
            .handlersP(States.idGeneration, childIdGenerationHandler)
