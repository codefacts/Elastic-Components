...
public class SqlMaps {
    ...
    static {
        ...
        builder
            ...
            .put(CriteriaCns.IN.toString(), (key, value) -> new SqlSymbolSpec(key, "in", toListSql(value)))
            .put(CriteriaCns.NIN.toString(), (key, value) -> new SqlSymbolSpec(key, "not in", toListSql(value)))
