...
import static elasta.orm.SqlHelper.*;
...
public class SqlInfo {
    ...
    static {
        ...
        builder
            ...
            .put(CriteriaCns.IN.toString(), (key, value) -> new SqlSymbolSpec(key, "in", SqlHelper.toListSql(value)))
            .put(CriteriaCns.NIN.toString(), (key, value) -> new SqlSymbolSpec(key, "not in", SqlHelper.toListSql(value)))
