 ...
 */
public class VertxUtilsImpl implements VertxUtils {
    private final Vertx vertx;
    private final FailureCodeHandler defaultFailureCodeHandler;
    private final ReplyHandler defaultReplyHandler;

    public VertxUtilsImpl(Vertx vertx, FailureCodeHandler defaultFailureCodeHandler, ReplyHandler defaultReplyHandler) {
        this.vertx = vertx;
